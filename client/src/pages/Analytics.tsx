...
import { getProductionAnalytics, getConsumptionAnalytics } from "@/api/analytics"
import { useToast } from "@/hooks/useToast"
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, BarChart, Bar, AreaChart, Area } from 'recharts'
import { Download, TrendingUp, TrendingDown, Zap, Sun } from "lucide-react"
...
export function Analytics() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Energy Analytics</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20">
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 text-sm">
              ...
              <span className={productionTrend >= 0 ? 'text-green-600' : 'text-red-600'}>
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20">
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 text-sm">
              ...
              <span className={consumptionTrend >= 0 ? 'text-red-600' : 'text-green-600'}>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-purple-700 dark:text-purple-300">Net Energy</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-orange-700 dark:text-orange-300">Efficiency</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-orange-900 dark:text-orange-100">
              {totalConsumption > 0 ? ((totalProduction / totalConsumption) * 100).toFixed(1) : 0}%
            </div>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <AreaChart data={productionData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Area type="monotone" dataKey="solar" stackId="1" stroke="#f59e0b" fill="#fbbf24" />
                  <Area type="monotone" dataKey="wind" stackId="1" stroke="#3b82f6" fill="#60a5fa" />
                  <Area type="monotone" dataKey="total" stroke="#10b981" fill="none" strokeWidth={2} />
                </AreaChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <LineChart data={consumptionData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="consumption" stroke="#ef4444" strokeWidth={2} />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
