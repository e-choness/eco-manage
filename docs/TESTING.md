...
All suites run inside the dev container. As of P2-04: **api 235, web 49, ingest 27, simulator 21,
shared 64, profiles 12, db 10, worker 13**, all passing. Lint and typecheck also pass. The api,
