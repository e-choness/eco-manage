...
All suites run inside the dev container. As of P3-03: **api 254, web 50, ingest 29, simulator 23, rules 35, recs 33,
shared 102, profiles 12, db 10, worker 44**, all passing. Lint and typecheck also pass. The api,
